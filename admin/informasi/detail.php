...
<head>
    ...
    <title>Detail Permintaan Informasi</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Detail Data Permintaan Informasi</h1>
                    </div>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="index.php">Data Permintaan Informasi</a></li>
                                    <li class="breadcrumb-item active" aria-current="page">Detail Data Permintaan Informasi</li>
                                </ol>
                            </nav>
                        </div>
                        <div class="card-body">
                        ...
                        $query = mysqli_query($db, "SELECT * FROM informasi, kategori where id_informasi='$id'");
                        ...
                        ?>
                            <table border="0">
                                ...
                                <tr>
                                    ...
                                    <td>:</td>
                                    <td>
                                        <img src="../../assets/img/informasi/<?php echo $d[8]; ?>" style="width: 700px;float: left;margin-bottom: 5px;">
                                    </td>
                                </tr>
                            </table>
                        </div>
